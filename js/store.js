...
function slider_owl(slider_id, visible1, visible2, visible3, visible4, margin, loop_param = true) {
...
$(document).ready(function() {
    ...
    slider_owl(".furniture .product-tab-content1", 1, 2, 3, 4, 20, false);
    ...
    slider_owl(".upsell-product", 1, 2, 3, 5, 20, false);
    ...
    if (back_to_top.length) {
        var scrollTrigger = parseInt(100, 10),
            backToTop = function() {
